...
const OnePersonModal: React.FC<OnePersonModalProps> = ({
  show,
  info,
  deleteLoading,
  onClose,
        ...
        >
          <div className="modal-content" style={{ width: '550px' }}>
            <div className="modal-header p-1">
              ...
              <button className="btn fs-3 ms-auto" onClick={onClose}>
                X
              </button>
            </div>
            <div className="modal-body">
              ...
              <div className="d-flex justify-content-evenly">
                ...
                <button
                  ...
                  onClick={onDelete}
                  disabled={deleteLoading ? deleteLoading === info.id : false}
                >
                  {deleteLoading && deleteLoading === info.id && (
                    <ButtonSpinner />
                  )}
                  Delete
                </button>
